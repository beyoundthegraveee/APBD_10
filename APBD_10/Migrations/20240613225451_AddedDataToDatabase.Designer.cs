...
namespace APBD_10.Migrations
{
    ...
    [Migration("20240613225451_AddedDataToDatabase")]
            ...
            modelBuilder.Entity("APBD_10.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPresctiprion = 1,
                            Date = new DateTime(2024, 6, 14, 0, 54, 50, 825, DateTimeKind.Local).AddTicks(5670),
                            DueDate = new DateTime(2024, 7, 14, 0, 54, 50, 825, DateTimeKind.Local).AddTicks(5714),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPresctiprion = 2,
                            Date = new DateTime(2024, 6, 14, 0, 54, 50, 825, DateTimeKind.Local).AddTicks(5720),
                            DueDate = new DateTime(2024, 7, 14, 0, 54, 50, 825, DateTimeKind.Local).AddTicks(5722),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
